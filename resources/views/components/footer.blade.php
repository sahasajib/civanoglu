<div class="container">
   <div class="pt-20">
           ...
           <<div class="flex-1 px-4">
               <div class="bg-white rounded-xl flex">
                   ...
                   <div class="p-4">
                       ...
                       <a href="" class="fullwidth-btn text-center">Read More</a>
                   </div>
               </div>
           </div>
           <div class="flex-1 px-4">
    ...
    <div class="pt-20 text-lg border-b-2 border-gray-300 pb-20 mb-20">
        ...
        <div class="flex -mx-4">
            ...
            <<div class="flex-1 px-4">
                <a href=""class="underline">Lorem ipsum dolor lorem ip.</a>
            </div>
        </div>
    </div>
    <div class="flex pb-12">
        <div class="w-1/4 pt-6">
            ...
            <p class="text-sm mt-12">Lorem ipsum dolor.</p>
        </div>
    ...
    <img class="w-full" src="/img/footer-bg.jpg" alt="">
</div>

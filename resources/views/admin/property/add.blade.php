                ...
                <form action="{{route('create-property')}}" method="post" class="p-6 bg-white border-b border-gray-200" enctype="multipart/form-data">@csrf
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <input class="form-inputs" type="text" id="name" name="name" value="{{old('name')}}" required>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input class="form-inputs" type="text" id="name_tr" name="name_tr" value="{{old('name_tr')}}" required>
                    ...
                    <div class="mb-6">
                            ...
                            <input class="form-inputs" type="file" id="featured_image" name="featured_image" required>
                    ...
                    <div class="mb-6">
                        ...
                        <input class="form-inputs" type="file" id="gallery_image" name="gallery_image[]" multiple required>
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <select class="form-label" id="location_id" name="location_id" value="{{old('location_id')}}" required>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input class="form-inputs" type="number" id="price" name="price" value="{{old('price')}}" required>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <select class="form-label" id="sale" name="sale">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <select class="form-label" id="type" name="type" required>
                                ...
                                <option {{old('type') == '0' ? 'selected="selected"' : ''}} value="0">Villa</option>
                    ...
                    <div class="flex -mx-4 mb-6">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input class="form-inputs" type="number" id="net_sqm" name="net_sqm" value="{{old('net_sqm')}}" required>
                        ...
                        <div class="flex-1 px-4">
                            <label for="gross_sqm" class="form-label">gross square meter<span class="required-text">*</span></label>
                            <input class="form-inputs" type="number" id="gross_sqm" name="gross_sqm" value="{{old('gross_sqm')}}" required>
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <textarea class="form-inputs" id="overview" name="overview" required>{{old('overview')}}</textarea>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <textarea class="form-inputs" id="overview_tr" name="overview_tr" required>{{old('overview_tr')}}</textarea>
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <textarea class="form-inputs" id="why_buy" name="why_buy" cols="30" rows="5" required>{{old('why_buy')}}</textarea>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <textarea class="form-inputs" id="why_buy_tr" name="why_buy_tr" cols="30" rows="5" required>{{old('why_buy_tr')}}</textarea>
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <textarea class="form-inputs" id="description" name="description" cols="30" rows="10" required>{{old('description')}}</textarea>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <textarea class="form-inputs" id="description_tr" name="description_tr" cols="30" rows="10" required>{{old('description_tr')}}</textarea>
